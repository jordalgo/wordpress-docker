...
if(strtolower(substr($_SERVER["SERVER_PROTOCOL"],0,4))=='http') {
  $server = sprintf('http://%s', $_SERVER['SERVER_NAME']);
} else {
  $server = sprintf('https://%s', $_SERVER['SERVER_NAME']);
}

define('WP_SITEURL', $server . '/wordpress');
...
/** Disallow editing of theme from within Dashboard **/
